        ...
        groupsEle.push(
          <section class="section">
            <h4 class="section-title">
              {group.title}
              <span class="title-tips">{group.tips}</span>
            </h4>
      ...
      this.formOption.btnList.forEach((btn) => {
        btnListEle.push(
          <el-button
            type={btn.type}
            on-click={() => {
              btn.onClick(this.$refs[this.formName], this.formModel);
            }}
          >
            {btn.text}
          </el-button>
    ...
    return (
      <div class="oa-form-container">
        <el-form
          ...
          label-width={this.formOption.labelWidth || '150px'}
        >
          {ele}
          <el-form-item
            label-width={this.isGroup ? '0' : this.formOption.labelWidth}
          >
